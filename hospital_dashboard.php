...
<div id="info">
      <div class="topmenu">
        ...
        <div class="bottom-center">
            <div class="tablinks selectedtab" onclick="function1(event,'hospitals')"> <div class="vertical"> Hospitals </div>  </div>
            <div class="tablinks" onclick="function1(event,'colleges')"> <div class="vertical"> Medical Colleges </div>  </div>
            <div class= "clear"></div>
        </div>
      </div>
